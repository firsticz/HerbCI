        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="dropdown-item" href="portfolio-2-col.html">Profile</a>
                    <a class="dropdown-item" href="portfolio-1-col.html">my history</a>
                    <a class="dropdown-item" href="portfolio-2-col.html">edit Profile</a>
